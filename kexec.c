...
int kernel_kexec(void)
{
    ...
    void (*sym_machine_shutdown)(void) = (void *)sym_kallsyms_lookup_name("machine_shutdown");
    ...
    int (*sym_platform_cpu_kill)(unsigned int) = (void *)sym_kallsyms_lookup_name("platform_cpu_kill");
    ...
    sym_disable_nonboot_cpus();
    preempt_disable();
    sym_smp_send_stop();
    
    /*
    sym_migrate_to_reboot_cpu();
    sym_cpu_hotplug_enable();
		disable_nonboot_cpus();
    sym_platform_cpu_kill(1);
    sym_platform_cpu_kill(2);
    sym_platform_cpu_kill(3);
    sym_spm_mtcmos_ctrl_cpu3(1, 1);
    sym_spm_mtcmos_ctrl_cpu2(1, 1);
    sym_spm_mtcmos_ctrl_cpu1(1, 1);
    sym_platform_cpu_disable(1);
    sym_platform_cpu_disable(2);
    sym_platform_cpu_disable(3);
    local_irq_disable();
    syscore_suspend();
    //sym_preempt_disable();
    //sym_smp_send_stop();
    ...
    sym_platform_cpu_disable(2);
    sym_platform_cpu_disable(3);
    sym_spm_mtcmos_ctrl_cpu3(0, 1);
    sym_spm_mtcmos_ctrl_cpu2(0, 1);
    sym_spm_mtcmos_ctrl_cpu1(0, 1);
    local_irq_disable();
    sym_smp_send_stop();
    */
	}
